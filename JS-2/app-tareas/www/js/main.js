...
class TodoList {
  constructor(form, list, keyName) {
    // Nombre del key con el que guardar la lista en el local Storage
    this.keyName = keyName;

    // Lista de todos
    this.todos = [];

    // Miro a ver si hay guardados en el localStorage y si los hay los uso como todos iniciales
    ...
    if (
      ...
      throw new Error("Hay elementos que faltan, comprueba tu HTML");
    }
  ...
  attachEvents() {
    ...
    // Cuando se pulse el botón de limpiar tareas ejecute el método cleanTodoList
    ...
    // Evento delegado: cada vez que clico en la lsita, di donde clico es en el checkbox,
    //marco el todo como hecho
  ...
  // Este método cambia el estado del todo (index) a hecho o a pendiente
  ...
  // Este método limpia los todos hechos
  cleanTodoList() {
